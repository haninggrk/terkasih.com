...
use App\Filament\Resources\MemorialPages\Pages\ViewMemorialPage;
use App\Filament\Resources\MemorialPages\Schemas\MemorialPageForm;
use App\Filament\Resources\MemorialPages\Schemas\MemorialPageInfolist;
...
class MemorialPageResource extends Resource
{
    ...
    protected static ?string $modelLabel = 'Memorial Page';

    protected static ?string $pluralModelLabel = 'Memorial Pages';
    ...
    {
        return MemorialPageInfolist::configure($schema);
    }
    ...
    public static function getPages(): array
    {
        return [
            ...
            'view' => ViewMemorialPage::route('/{record}'),
